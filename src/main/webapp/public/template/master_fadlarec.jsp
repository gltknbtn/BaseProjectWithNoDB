...
<head>
	...
	<!-- Bootstrap Core CSS -->
	<%-- <link href="<c:url value='/resources/vendor_fadlarec/bootstrap/css/bootstrap.min.css'/>" rel="stylesheet" /> --%>
	...
	<link
		...
		<link href="<c:url value='/resources/css_fileUpload/fileinput.css'/>"rel="stylesheet" />
...
<body style="padding-top: 0 !important;">
	...
	<script src="<c:url value='/resources/js_fadlarec/jquery.bcSwipe.js' />"></script>
	
	
		<script src="<c:url value='/resources/js_fileUpload/fileinput.js' />"></script>
    <script src="<c:url value='/resources/js_fileUpload/locales/fr.js' />"></script>
    <script src="<c:url value='/resources/js_fileUpload/locales/es.js' />"></script>
